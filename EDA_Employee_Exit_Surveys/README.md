...
For full analysis click __[here](https://github.com/Treyeth/Projects/blob/master/EDA_Employee_Exit_Surveys/EDA_Employee_Exit_Surveys.ipynb)__.
...
The scope of the project is to find the answer to a few questions:
